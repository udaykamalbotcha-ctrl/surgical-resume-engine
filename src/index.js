...
import { searchJobsTool, searchJobsHandler, tailorResumeTool } from './tools/index.js';
...
tailorResumePrompt(server);
searchJobsTool(server, sseManager);
tailorResumeTool(server);
  ...
  try {
    ...
    if (ENABLE_SSE) {
      try {
        ...
        httpServer.headersTimeout = 190000;
